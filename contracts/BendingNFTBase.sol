 ...
 * {ERC721Enumerable}.
 */
contract BendingNFTBase is BendingGamePlay, ERC165, IERC721 {
    ...
    function transferFrom(
        ...
        require(owner == _from || getApproved(_tokenId) == msg.sender || isApprovedForAll(owner, msg.sender), "The bender should belong to you");
    ...
    function getApproved(uint256 _tokenId) override public view returns (address operator) {
        ...
        return bendersApprovals[_tokenId];
    }
